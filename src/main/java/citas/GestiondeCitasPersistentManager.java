...
public class GestiondeCitasPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "GestiondeCitas";
	...
	private GestiondeCitasPersistentManager() throws PersistentException {
	...
	public Configuration createConfiguration() {
		...
		configuration.addAnnotatedClass(citas.Cita.class);
		configuration.addAnnotatedClass(citas.Cita_Activa.class);
		configuration.addAnnotatedClass(citas.Cita_Realizada.class);
		configuration.addAnnotatedClass(citas.Asunto.class);
		configuration.addAnnotatedClass(citas.Cliente.class);
		configuration.addAnnotatedClass(citas.Fecha.class);
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new GestiondeCitasPersistentManager();
		}
